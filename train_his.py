...
context_pairs_train = get_context_pairs(graphs, num_time_steps, FLAGS.filepath)

# Load evaluation data.
train_edges, train_edges_false, val_edges, val_edges_false, test_edges, test_edges_false = \
    get_evaluation_data(adj_sparse, num_time_steps, FLAGS.filepath)
